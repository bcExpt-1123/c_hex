...
const ESign = () => {
  return (
    <TermsDiv>
      <h2 class="text-center text-header">E-Sign Consent</h2>
      ...
      notify us of any change in your email address or cell phone number. This can be done by signing into your account and following the directions there. Your consent applies to all communications from Calahex during the period that you hold an account
        with us. You are free to revoke your consent to receive electronic communications by sending us an email request to <a href="">info@calahex.com.</a> In the case you withdraw your consent you will have to transfer your Digital Assets within 48
