...
import { colors, TableRow } from "@material-ui/core";
...
const FutureDiv = styled.div`
  ...
  .sider2 {
    ...
    .order-buy-table-container {
      /* height: ${props => (props.show == 2) ? 'calc(100vh - 214px);' : (props.show == 1) ? '0;' : 'calc(50vh - 107px);'} */
      ${props => {
    ...
    .order-sell-book {
      ...
      .order-sell-book-header {
        ...
        border-bottom: 1px solid #aaa;
        text-align: center;
        /* display: ${props => props.show == 1 ? 'none;' : 'block;'} */
        h4 {
          margin: 5px 0;
          color: #C74A4D;
        }
