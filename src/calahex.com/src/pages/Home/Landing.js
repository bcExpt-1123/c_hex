...
const Landing = (props) => {
    ...
    return (
        <div className={classes.root}>
          ...
          <Grid container className={classes.container} data-aos={'fade-up'}>
            ...
            <Grid item md={6} className={classes.cardContent}>
              ...
              <div className={classes.center}>
                <Link to={""} className={classes.textDecoNone}>
                  <Button
                    color="default"
                    variant="contained"
                    size="small"
          ...
          <Grid container className={classes.container} data-aos={'fade-up'}>
            <Grid item md={6} className={clsx(classes.cardContent, classes.pt30, classes.p20)}>
              ...
              <div className={classes.right}> <Link to={''} className={classes.detail}>Contact</Link></div>
              ...
              <div className={classes.right}> <Link to={''} className={classes.detail}>Details...</Link></div>
            </Grid>
