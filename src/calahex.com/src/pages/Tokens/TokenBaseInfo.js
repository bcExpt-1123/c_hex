...
const headCells = [
    ...
    { id: 'token_logo', numeric: false, disablePadding: false, label: '', sortable: false },
    ...
    { id: 'token_24h_high', numeric: true, disablePadding: false, label: '24h Change', sortable: true },
    { id: 'token_24h_low', numeric: true, disablePadding: false, label: '24h Change', sortable: true },
    { id: 'token_24h_volume', numeric: true, disablePadding: false, label: '24h Change', sortable: true },
    { id: 'token_whitepaper', numeric: false, disablePadding: false, label: 'Whitepaper', sortable: false },
    { id: 'token_process_row', numeric: false, disablePadding: false, label: '', sortable: false },
];
...
const TokenBaseInfo = (props) => {
    const { selectLanding, isAuthenticated, CreateToken, GetTokenInfoBase } = props;
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left"><img src={row.token_logo} /></TableCell>
                                            ...
                                            <TableCell align="center"><Link to={row.token_whitepaper} className={classes.whitePaper}><GetAppIcon className={classes.downloadIcon} /></Link></TableCell>
                                            <TableCell align="left"><Link to={row.token_whitepaper} className={classes.showDetail}>Show Detail</Link></TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
