...
const CryptoExchange = (props) => {
    ...
    cryptoOrderLists.asks = cryptoOrderLists.asks.reverse();
                            ...
                            <TableBody>
                                {cryptoOrderLists.asks.map((row, i) => (
                                    <Tooltip key={i} type={1} title={
                                        ...
                                        <BgTableRow total={row.total} max={cryptoOrderLists.asks[0].sum_total}>
    ...
    if (isAuthenticated) {
        adminPan = <Grid item className="adminPanLogin">
            ...
            >
                ...
                <ButtonTab className="tabButton" label="Sell" className="sellButton"  {...a11yProps(1)} />
            </ButtonTabs>
    ...
    return (
        <CryptoDiv className={classes.root} show={show} responsive={hiddenC} match={!match2} match1={!match1} >
