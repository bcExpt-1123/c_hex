...
class TokenController extends Controller
{
    ...
    {
        $token_list = Tokens::select('token_pair_type', 'token_logo', 'token_symbol', 'token_decimal', 'token_whitepaper')->where('status', 'approved')->get();
    ...
    public function create(Request $request)
    {
        $request->validate([
            ...
            'token_decimal' => 'required|integer',
            'token_whitepaper' => 'required|string',
            'token_pair_type' => 'required|string',
            'token_logo' => 'required|string',
            'status' => 'string'
        ]);
        $token = new Tokens([            
            ...
            'token_whitepaper' => $request->token_whitepaper,
